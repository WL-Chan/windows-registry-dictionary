...
Validate JSON syntax using any JSON linter.

Confirm all category names exist in categories.json.

Ensure descriptions are concise and neutral.

Avoid including user-specific registry keys or transient entries.
